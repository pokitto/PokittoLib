...
QDEF(MP_QSTR_buttons_repeat, (const byte*)"\xc8\x0e" "buttons_repeat")
...
QDEF(MP_QSTR_isRunningPokitto, (const byte*)"\x2a\x10" "isRunningPokitto")
...
QDEF(MP_QSTR_updatePokitto, (const byte*)"\xe6\x0d" "updatePokitto")
