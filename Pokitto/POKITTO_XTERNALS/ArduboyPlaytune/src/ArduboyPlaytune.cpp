...
//added this empty function that returns true - jonne
boolean footrue() {
    return true;
}

// added this constructor - jonne
ArduboyPlaytune::ArduboyPlaytune()
{
  outputEnabled = footrue;
}
